// 基础体素：长方体/圆柱/圆锥/球 对话框与参数化创建（从 main_window.cpp 拆出）
...
GeometryPlacement::AxisPlacement makePlacement(bool hasOrigin,
                                               double originX,
                                               double originY,
                                               double originZ,
                                     ...
                                     bool axisReversed)
{
    const GeometryPlacement::AxisPlacement placement =
        makePlacement(hasOrigin, originX, originY, originZ,
    ...
    Command* command = new CreateGeometryCommand(
        ...
        QColor(255, 140, 0),
        PrimitiveGeometry::PrimitiveBuildRequest(CUBOID, length, width, height, placement)
        );
                                     ...
                                     bool axisReversed)
{
    ...
    Command* command = new CreateGeometryCommand(
        ...
        QColor(255, 140, 0),
        PrimitiveGeometry::PrimitiveBuildRequest(CYLINDER, radius, height, 0.0, placement)
        );
    executeCommand(command);
}
// 点击圆锥体按钮
                                  ...
                                  bool axisReversed)
{
    ...
    Command* command = new CreateGeometryCommand(
        ...
        QColor(255, 140, 0),
        PrimitiveGeometry::PrimitiveBuildRequest(CONE, radius1, radius2, height, placement)
        );
    executeCommand(command);
}
// 点击球体按钮
                                    ...
                                    bool hasOrigin, double originX, double originY, double originZ)
{
    ...
    Command* command = new CreateGeometryCommand(
        ...
        QColor(255, 140, 0),
        PrimitiveGeometry::PrimitiveBuildRequest(SPHERE,
                                                 radius,
                                                 thetaResolution,
                                                 phiResolution,
                                                 placement)
