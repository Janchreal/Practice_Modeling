...
gp_Ax2 Widget::cuboidInteractiveAxisSystem() const
{
    ...
    placement.origin = cuboidInteractiveOrigin_;
    placement.axisDirection = currentAxisDirection;
    placement.axisReversed = axisReversed;
    placement.hasCustomVectorDir = hasCustomVectorDir_;
    placement.customVectorDir = customVectorDir_;
    return GeometryPlacement::makeAxisSystem(placement);
}
