// 表达式、参数更新、模型形状更新与布尔结果再生（从 widget.cpp 拆出）
#include "widget.h"
#include "ui_widget.h"
...
void Widget::regenerateModel(int index, bool triggerCascade)
{
    ...
    try {
        ...
        switch (history.type) {
        case CUBOID:
            newShape = createCuboidShape(history.param1, history.param2, history.param3,
            ...
            break;
        case CYLINDER:
            newShape = createCylinderShape(history.param1, history.param2,
                                          history.hasOrigin, history.originX, history.originY, history.originZ,
                                          history.axisDirection,
                                          history.axisReversed,
                                          history.hasCustomVectorDir,
            ...
            break;
        case CONE:
            newShape = createConeShape(history.param1, history.param2, history.param3,
                                      history.hasOrigin, history.originX, history.originY, history.originZ,
                                      history.axisDirection,
                                      history.axisReversed,
                                      history.hasCustomVectorDir,
            ...
            break;
        case SPHERE:
            newShape = createSphereShape(history.param1,
                                        history.hasOrigin, history.originX, history.originY, history.originZ);
            break;
        case BOOLEAN_RESULT:
        case EXTRUSION:
