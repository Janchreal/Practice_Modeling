...
TopoDS_Shape Widget::rebuildBaseShapeFromExtrusionRecipe(const ExtrusionRecipeData& recipe)
{
    ...
    case CUBOID:
        return PrimitiveGeometry::buildCuboidShape(recipe.baseParam1, recipe.baseParam2, recipe.baseParam3,
                                                   recipe.baseHasOrigin, recipe.baseOriginX, recipe.baseOriginY, recipe.baseOriginZ,
                                                   AxisDirection::Z, false, false, gp_Dir(0, 0, 1));
    case CYLINDER:
        return PrimitiveGeometry::buildCylinderShape(recipe.baseParam1, recipe.baseParam2,
                                                     recipe.baseHasOrigin, recipe.baseOriginX, recipe.baseOriginY, recipe.baseOriginZ,
                                                     AxisDirection::Z, false, false, gp_Dir(0, 0, 1));
    case CONE:
        return PrimitiveGeometry::buildConeShape(recipe.baseParam1, recipe.baseParam2, recipe.baseParam3,
                                                 recipe.baseHasOrigin, recipe.baseOriginX, recipe.baseOriginY, recipe.baseOriginZ,
                                                 AxisDirection::Z, false, false, gp_Dir(0, 0, 1));
    case SPHERE:
        return PrimitiveGeometry::buildSphereShape(recipe.baseParam1,
                                                   recipe.baseHasOrigin, recipe.baseOriginX, recipe.baseOriginY, recipe.baseOriginZ);
    default:
