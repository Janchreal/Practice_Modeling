...
public:
     ...
     */
    ExtrusionCommand(Widget* widget,
    ...
    static bool extrudeFromRecipe(Widget* widget, const ExtrusionRecipeData& recipe, TopoDS_Shape& resultShape);
...
private:
    ...
    /**
     * @brief 检查内外线框
     * 完全按照ExtrusionHelper::checkInnerWires的逻辑
     */
    ...
    /**
     * @brief 创建带锥度的偏移线框
     * 完全按照ExtrusionHelper::createTaperedPrismOffset的逻辑
     */
    static void createTaperedPrismOffset(const TopoDS_Wire& sourceWire,
